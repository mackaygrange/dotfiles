...
TERM_BRIGHT_RED="CB8087"      # color9
TERM_BRIGHT_GREEN="B5CBA3"    # color10
TERM_BRIGHT_YELLOW="EFD5A2"   # color11
TERM_BRIGHT_BLUE="9AB3CD"     # color12
TERM_BRIGHT_MAGENTA="C3A4BD"  # color13
TERM_BRIGHT_CYAN="8FBCBB"     # color14
TERM_BRIGHT_WHITE="EFF2F6"    # color15
