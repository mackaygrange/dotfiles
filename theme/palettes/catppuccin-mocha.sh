...
TERM_BRIGHT_RED="F5A2B9"      # color9
TERM_BRIGHT_GREEN="A9E7DD"    # color10
TERM_BRIGHT_YELLOW="FAE7BF"   # color11
TERM_BRIGHT_BLUE="A0C3FB"     # color12
TERM_BRIGHT_MAGENTA="D5B7F8"  # color13
TERM_BRIGHT_CYAN="FBC29F"     # color14
TERM_BRIGHT_WHITE="D7DEF6"    # color15
