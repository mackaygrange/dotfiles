...
TERM_BRIGHT_RED="FF6E6E"      # color9
TERM_BRIGHT_GREEN="69FF94"    # color10
TERM_BRIGHT_YELLOW="FFFFA5"   # color11
TERM_BRIGHT_BLUE="D6ACFF"     # color12
TERM_BRIGHT_MAGENTA="FF92DF"  # color13
TERM_BRIGHT_CYAN="A4FFFF"     # color14
TERM_BRIGHT_WHITE="FFFFFF"    # color15
