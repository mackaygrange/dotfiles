...
TERM_BRIGHT_RED="FD6F9E"      # color9
TERM_BRIGHT_GREEN="B6E39B"    # color10
TERM_BRIGHT_YELLOW="FFE484"   # color11
TERM_BRIGHT_BLUE="A4FFFF"     # color12
TERM_BRIGHT_MAGENTA="D9BFFF"  # color13
TERM_BRIGHT_CYAN="FFDCA0"     # color14
